...
def main(pano_path):
    ...
    output_folder = "Merged/Perspective_output"
    ...
    for i, deg in enumerate(np.linspace(0, 360, 8)):  
        ...
        perspective_images.append(output_image_1)
        perspective_images.append(output_image_2)
        perspective_images.append(output_image_3)
